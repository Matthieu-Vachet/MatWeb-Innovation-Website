    ...
    return (
        ...
        >
            <div className="w-screen h-full flex flex-col justify-center items-center text-center">
                ...
                <div className="flex justify-center items-center relative z-10 -mt-28 lg:-mt-0 ">
                    <div className="max-w-[90vw] md:max-w-[80vw] lg:max-w-[80vw] flex flex-col items-center justify-center gap-10">
                        <h1 className="uppercase tracking-widest text-xl md:text-4xl lg:text-5xl imac:text-6xl text-center text-white-200 translate-y-[-1rem] animate-fade-in opacity-0">
                            La page demandée n&apos;est pas disponible
                        </h1>
                        <div className="text-center uppercase translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:100ms] lg:max-w-[75vw] border-t-4 border-b-4 border-white-100 pt-5">
                            <h2 className="text-3xl md:text-5xl lg:text-6xl imac:text-7xl">
                                Erreur
                            </h2>
                            <h3 className="text-[5rem] md:text-[9rem] lg:text-[9rem] imac:text-[15rem] font-semibold bg-gradient-to-r from-purple to-white-200 bg-clip-text text-transparent">
                                404
                            </h3>
                        </div>

                        <p className="text-xl md:text-3xl lg:text-3xl font-normal text-white-200 text-center translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
