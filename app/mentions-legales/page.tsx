            ...
            <div className="w-screen h-full flex flex-col justify-center items-center text-center">
                ...
                <div className="flex relative z-10">
                    <div className="max-w-[95vw] md:max-w-[80vw] lg:max-w-[70vw] flex flex-col">
                        <h1 className="text-gradient font-semibold title-size md:pt-5 translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:100ms] text-center">
                            Mentions légales
                        </h1>
                        <div className="mt-10 text-start">
                            ...
                            <section className="mt-10">
                                ...
                                <p className="text-white-100 text-md md:text-xl">
                                    ...
                                    reproduction, représentation, modification, publication, totale
                                    ou partielle de ce site ou de ses contenus est interdite sans
                            ...
                            <section className="mt-10">
                                ...
                                <p className="text-white-100 text-md md:text-xl">
                                    ...
                                    d&apos;aucune sorte. Nous ne saurions être tenus responsables
                                    des éventuels dommages directs ou indirects résultant de
                                    l&apos;accès à ce site ou de son utilisation.
                                </p>
                            </section>
                            <section className="mt-10">
                                <h2 className="subtitle-size text-gradient font-semibold mb-5">
                                ...
                                <p className="text-white-100 text-md md:text-xl">
                                    ...
                                    des données vous concernant. Pour exercer ces droits, veuillez
