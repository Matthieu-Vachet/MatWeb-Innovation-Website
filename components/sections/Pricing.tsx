            ...
            <div className="max-w-[95vw] imac:max-w-[70vw] mx-auto">
                ...
                <div className="mx-auto max-w-[95vw] lg:max-w-[100vw] imac:max-w-[60vw] mt-26 lg:mt-20">
                    ...
                    <div className="flow-root z-20 bg-transparent">
                        <div className="mx-auto max-w-full md:max-w-[95vw] lg:max-w-7xl">
                            <div className="relative flex flex-col gap-10">
                                <div className="flex lg:hidden overflow-x-auto scrollbar-hide gap-10 sm:gap-8">
                                    {filteredTiers.map((tier) => (
                                        <div
                                            key={tier.id}
                                            className={`relative flex-shrink-0 w-[95vw] flex flex-col justify-between rounded-3xl p-8 shadow-xl ring-1 ring-gray-900/10 [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#8686f01f_inset] ${
                                                tier.bestSeller
                                    ...
                                    {filteredTiers.map((tier) => (
                                        <div
                                            ...
                                            className={`relative flex-shrink-0 w-full sm:w-auto flex flex-col justify-between rounded-3xl p-8 shadow-xl ring-1 ring-gray-900/10 sm:p-10 [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#8686f01f_inset] ${
                                                tier.bestSeller
                                                    ? "[border:2px_solid_rgba(144,91,244,.5)] scale-105"
                                                    : ""
                                            }`}
                                        >
                                            {tier.bestSeller && (
