            ...
            >
                <div className="flex flex-col  w-full justify-items-start items-start text-left gap-5 Z-20 ">
                    ...
                    <p className="w-full max-w-3xl text-md md:text-lg font-semibold text-white-100 Z-20">
                        Passionné par l&apos;informatique depuis mon enfance, j&apos;ai toujours été
                        fasciné par le potentiel illimité de la technologie. Très tôt, j&apos;ai
                        commencé à explorer le monde de la programmation, ce qui m&apos;a conduit à
                        une carrière d&apos;intégrateur web. Pour moi, chaque ligne de code est une
                        œuvre d&apos;art, une opportunité de créer et d&apos;innover.
                        Aujourd&apos;hui, en tant que développeur indépendant, je suis prêt à mettre
                        ma passion et mes compétences au service de vos projets.
                    </p>
                </div>
                <div className="flex flex-col w-full justify-items-end items-end text-right gap-5 Z-20">
                    ...
                    <p className="w-full max-w-3xl text-md md:text-lg font-semibold text-white-100 Z-20">
                        ...
                        professionnelle. Curieux et autodidacte, j&apos;ai appris les bases de la
                        programmation à travers divers projets personnels. Depuis que j&apos;ai
                        rejoint le programme d&apos;intégrateur web chez OpenClassrooms, j&apos;ai
                        approfondi mes connaissances en HTML, CSS, Sass, JavaScript, et surtout
                        React. Mon orientation vers les technologies modernes comme React, Next.js
                        et Tailwind CSS me permet de créer des sites web dynamiques, réactifs et
                        optimisés, prêts à répondre aux besoins des utilisateurs modernes.
                    </p>
                </div>
                <div className="flex flex-col w-full justify-items-start items-start text-left gap-5 Z-20">
                    ...
                    <p className="w-full max-w-3xl text-md md:text-lg font-semibold text-white-100 Z-20">
                        Au cours de ma formation et de mes expériences, j&apos;ai développé un large
                        éventail de compétences techniques et créatives. Je maîtrise les langages
                        HTML, CSS, Sass pour le style, ainsi que JavaScript, React, Next.js et
                        Tailwind CSS pour des interfaces utilisateur interactives et performantes.
                        Travaillant désormais en tant que développeur indépendant, j&apos;ai eu
                        l&apos;occasion de mener à bien plusieurs projets variés, allant de simples
                        pages web à des applications complexes. Mon objectif est de continuer à
                        améliorer mes compétences tout en contribuant à des projets innovants et de
                        qualité.
                    </p>
                </div>
                <AnimatePresence>
