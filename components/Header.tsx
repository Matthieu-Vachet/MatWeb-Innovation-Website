        ...
        <header className="fixed top-0 left-0 z-50  w-full border-b border-transparent-white backdrop-blur-[12px] p-4">
            <Container className="flex justify-between items-center">
                ...
                >
                    <nav
                        className={classNames(
                            "fixed bg-black-100/90 top-0 left-0 h-[100vh] w-[100vw] overflow-auto transition-opacity duration-500 md:relative md:top-0 md:block md:h-auto md:w-auto md:translate-x-0 md:overflow-hidden md:bg-transparent md:opacity-100 md:transition-none",
                            hamburgerMenuIsOpen
                ...
                <div className="relative hidden md:flex z-10 flex-col justify-center md:justify-end opacity-50">
                    ...
                    <div className="flex flex-row gap-1 items-center">
                        <IoIosMail className="text-black-100 dark:text-white-200 text-sm lg:text-md" />
                        <span className="text-black-100 dark:text-white-200 text-xs lg:text-sm">
