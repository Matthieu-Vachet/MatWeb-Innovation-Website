...
const Service = () => {
    ...
    return (
        <section id="Service" className="bg-black-100 pt-[15rem] ">
            <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto dark:bg-transparent bg-white absolute w-full z-0 bottom-[130px] right-[20px]">
            ...
            <h1 className=" heading text-white pb-5 absolute">
