    ...
    return (
        ...
        >
            ...
            <span
                ...
                className="duration-[var(--transition-length)] delay-[var(--delay)] absolute inset-0 m-auto h-fit w-fit ease-linear animate-in fade-in flex flex-col items-center"
            >
                {currentPercent}
            </span>
        </div>
