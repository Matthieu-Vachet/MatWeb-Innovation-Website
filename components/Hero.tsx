...
const Hero = () => {
    return (
        <section id="Home" className="pb-0 pt-0 px-4 bg-gradient-to-b from-purple-100 to-black-100">
            ...
            {/* Background Grid */}
            <div className="h-[80vh]  w-full  dark:bg-grid-white/[0.03] flex items-center justify-center absolute top-0 left-0 mt-0 mb-0 pt-0 pb-0">
            ...
            <div className="flex justify-center relative z-10">
                <div className="max-w-[90vw] md:max-w-[80vw] lg:max-w-[80vw] flex flex-col items-center justify-center">
                    <p className="pt-[8rem] md:pt-[10rem] imac:pt-[17rem] uppercase tracking-widest text-sm md:text-lg text-center text-black dark:text-white-200 translate-y-[-1rem] animate-fade-in opacity-0">
                        Matthieu Vachet
                    </p>
